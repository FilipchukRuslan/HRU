    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutUnion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutUnion_Image_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(nullable: true),
                    Text = table.Column<string>(nullable: true),
                    ImageMin = table.Column<string>(nullable: true),
                    Image_Id = table.Column<int>(nullable: false),
                    ImageId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carousel_Image_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Image",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FBPost = table.Column<string>(nullable: true),
                    Date = table.Column<DateTime>(nullable: false),
                    PersonName = table.Column<string>(nullable: true),
                    PersonLink = table.Column<string>(nullable: true),
                    Image_Id = table.Column<int>(nullable: false),
                    ImageId = table.Column<int>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParnerAbout = table.Column<string>(nullable: true),
                    isCrew = table.Column<bool>(nullable: false),
                    Image_Id = table.Column<int>(nullable: false),
                    ImageId = table.Column<int>(nullable: true),
                    AboutUnion_Id = table.Column<int>(nullable: false),
                    AboutUnionId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AboutUnionId,
                        principalTable: "AboutUnion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Partners_Image_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Image",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
